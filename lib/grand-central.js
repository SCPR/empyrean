  ...
  routeMessage (message) {
    ...
    return this.db.upsert(attributes._id, this._deltaFunc)
      ...
      .then((doc) => {
        ...
        doc.adapter         = attributes.adapter || "missing";
        ...
        promise = promise.then(() => {
          doc.syndications[doc.adapter] = doc.syndications[doc.adapter] || {};
          let syndication               = doc.syndications[doc.adapter];
          let metadata    = {
          ...
          let adapter     = (this.adapters[doc.adapter] || this.adapters['missing'])[metadata.method];
